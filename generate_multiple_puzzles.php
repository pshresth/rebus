...
//            echo '<input type="radio" name="defaultSize" checked onclick="changeImage()" /><label>Default</label>
//                    <input style="margin-left:5px;" size="2px" type="text" name="default" id="defaultSize"/>';
//            echo '<input type="radio" style="margin-left:15px;" name="heightDriven" onclick="changeImage()" /><label>Height Driven</label>
//                    <input style="margin-left:5px;" size="2px" type="text" name="heightDriven" id="heightDriven"/>';
//            echo '<input type="radio" style="margin-left:15px;" name="widthDriven" onclick="changeImage()" /><label>WidthDriven</label>
